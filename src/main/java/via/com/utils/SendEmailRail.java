...
//		String toEmail2 = "nitish.manjarwar@ebix.com";
		...
		String toEmail2 = "pankaj.yadav@ebix.com";
		...
		try {
			...
			msg.setSubject("Automation Test Execution Report - Rail Booking");
			...
			pdfAttachment.attachFile(System.getProperty("user.dir")+"\\src\\test\\resources\\testDataRail\\viaDataRail.xlsx");
